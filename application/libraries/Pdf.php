...
//        echo $this->fl_header; die;
    ...
    public function Footer() {
        ...
        // Page number
        $this->Cell(0, 0, 'Solution by: Zone Venture Software Solution - Dharga Town, Sri Lanka. Contact: +94775440889', 0, false, 'L', 0, '', 0, false, 'T', 'M');
...
//        $this->Text(12, 25, 'Motor interial Fixing and Spare suppliers of all Japanese Diesel & Petrol Vehicles', false, false, true, 0, 0, '', false,'',1);
        ...
        $this->writeHTMLCell(90,20,110,35,$header_info2); 
         //water_mark 
        $image_file = DEFAULT_IMAGE_LOC.'logo_water_mark.jpg';
        $this->Image($image_file, 30, 95,  150, '', 'JPG', '', 'T', false, 72, '', false, false, 0, false, false, false);
...
//        $fontname = TCPDF_FONTS::addTTFfont('storage/fonts/CanelaBarkBold_PERSONAL.ttf', 'TrueTypeUnicode', '', 96);
        // use the font
        $this->SetFont($fontname, '', 25, '', false);
        $this->SetTextColor(48,75,105);
        $this->Text('60', 9, $company_dets[0]['company_name'], false, false, true, 0, 0, 'left', false,'',1);
