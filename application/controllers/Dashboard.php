	...
	public function index(){ 
        ...
        function getData(){
            ...
            $data['total_1']= array(
                                                ...
                                                'count' => $this->Dashboard_model->get_tbl_couts(COMPANIES),
                                                );
            $data['total_2']= array(
                                            'label' =>'Customers',
                                            'count' => $this->Dashboard_model->get_tbl_couts(COMPANIES),
        ...
        function get_barchart_data(){
            ...
            for ($i = 0; $i < 7; $i++) {
                ...
                $data_bc[$i]['res']=$this->Dashboard_model->get_number_inv(COMPANIES);
                $data_bc[$i]['inv']=$this->Dashboard_model->get_number_inv(COMPANIES);
            }
...
//            echo '<pre>';            print_r($data_bc);die;
        ...
        function get_donut_data(){
            $data_donut = array();
                $data_donut['res']=$this->Dashboard_model->get_number_inv(COMPANIES);
                $data_donut['inv']=$this->Dashboard_model->get_number_inv(COMPANIES);
                $data_donut['itm']=$this->Dashboard_model->get_number_inv(COMPANIES,'','','');
