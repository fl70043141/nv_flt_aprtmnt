...
//            echo '<pre>';            print_r($this->input->post()); die;
        ...
        function create_acc_ajax($data1){
            unset($data1['function_name']);
            $id = get_autoincrement_no(GL_QUICK_ENTRY_ACC);
            $code = gen_id('QE', GL_QUICK_ENTRY_ACC, 'id',3);
            $data = array(
                            'id' => $id,
        ...
        function get_dropdown_formodal($table='GL_QUICK_ENTRY_ACC',$name='account_name',$id="id"){ 
             echo json_encode(get_dropdown_data(GL_QUICK_ENTRY_ACC, $name, $id)); 
        }
