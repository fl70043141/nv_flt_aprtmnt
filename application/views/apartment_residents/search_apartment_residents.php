 ...
 <br><hr>
            ...
            <?php echo form_open("", 'id="form_search" class="form-horizontal"')?>  
                    ...
                    <div class="box-body">
                        <div class="row"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('resident_name', set_value('resident_name'), 'id="resident_name" class="form-control" placeholder="Search by Supplier Name"'); ?>
                            ...
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_input('resident_code', set_value('resident_code'), 'id="resident_code" class="form-control" placeholder="Search by Apartment Number"'); ?>
                            ...
                            <div class="col-md-6"> 
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Apartment/Building<span style="color: red"></span></label>
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <?php echo form_dropdown('apartment_id',$apartment_list, set_value('apartment_id'), 'id="phone" class="form-control select2"'); ?>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Result of Apartments list </h3>
            </div>
            <!-- /.box-header -->
