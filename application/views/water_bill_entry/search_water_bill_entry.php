 ...
 <br><hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('tarrif_name', set_value('tarrif_name'), 'id="tarrif_name" class="form-control" placeholder="Search by Tarrif Name"'); ?>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Result of Water Tarrif list </h3>
            </div>
            <!-- /.box-header -->
