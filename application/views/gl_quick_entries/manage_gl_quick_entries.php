                                       ...
                                       <div class="form-group">
                                           ...
                                           <div class="col-md-9">                                   
                                                <div class="input-group">
                                                    ...
                                                    <?php echo form_input('bill_month', set_value('bill_month',date('F-Y',$result['bill_month'])), 'id="bill_month" class="form-control" readonly placeholder="Click to select month"'); ?>
                                           ...
                                           <tr>
                                               ...
                                               <td>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label for="quick_entry_account_id">.</label>
                                                   <div class="col-md-2"><a id="add_acc_btn" class="btn btn-success"><span class="fa fa-plus"></span></a></div>
                                               </td> 
...
<!--                                <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <a href="<?php echo base_url('Quick_entries');?>" class="btn btn-app pull-right  primary"><i class="fa fa-backward"></i>Back</a>
...
<?php $this->load->view('gl_quick_entries/add_dropdown_modal'); ?>
<script>
