...
$(document).ready(function(){  
	...
	function get_results(){
        $.ajax({
			url: "<?php echo site_url('Apartments/search');?>",
			type: 'post',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('apartment_name', set_value('apartment_name'), 'id="apartment_name" class="form-control" placeholder="Search by Supplier Name"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('apartment_name');?></span>
                                        </div>
                                    </div> 
                                </div> 
                            <div class="col-md-6"> 
