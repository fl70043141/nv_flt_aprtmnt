...
|
*/
define('SYSTEM_NAME', 'APARTMENT BILLER');
define('SYSTEM_CODE', 'NV_APARTMENT_1');
define('SYSTEM_SHOTR_NAME', 'ZV APRT');
define('SYSTEM_POWERED_BY', 'Zone Venture Solution');
...
define('GL_MENTEN_ENTRY',            TB_PREFIX.'maintenance_entry');
...
define('APARTMENTS',                    TB_PREFIX.'apartments');
define('APARTMENT_RESIDENT',                    TB_PREFIX.'apartment_resident');
define('TARRIF_WATERBILL',                    TB_PREFIX.'tarrif_waterbill');
define('TARRIF_WATERBILL_ROWS',                    TB_PREFIX.'tarrif_waterbill_rows');
define('WATERBILL_ENTRY',                    TB_PREFIX.'water_bill_entry');
